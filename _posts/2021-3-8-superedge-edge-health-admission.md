---
layout: post
title: SuperEdge分布式健康检查深度剖析——edge-health-admission
date: 2021-3-8 19:10:31
category: 技术
tags: Kubernetes SuperEdge
excerpt: 本文首先说明了SuperEdge分布式健康检查云端组件产生的原因，并介绍了Kubernetes Admission Controllers以及Admission Webhooks，之后从源码角度深度剖析了云端组件edge-health-admission的核心实现，有助于读者对SuperEdge分布式健康检查的进一步理解和使用
---
